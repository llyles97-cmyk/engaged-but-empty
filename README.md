...
**Engaged but Empty** is available as a full 12-slide presentation.

The deck covers all three claims, the original SQL analysis, the framework, and the Spotify case application. Built in Gamma with a dark high-contrast theme.

📊 **[View the presentation deck](deck/Engaged-but-Empty.pptx)**

### Deck Contents

| Slide | Title |
|---|---|
| 1 | Engaged but Empty — Opening frame |
| 2 | The Belief the Industry Runs On |
| 3 | The Problem With That Belief |
| 4 | Claim 1 — Streaming: Volume Without Depth |
| 5 | Claim 2 — Platform: Engagement Without Conversion |
| 6 | Claim 3 — Consumer: Activity Without Loyalty |
| 7 | The SQL Analysis — Original Data |
| 8 | What the Data Has in Common |
| 9 | What Companies Are Losing |
| 10 | The Framework — What to Measure Instead |
| 11 | Case Application — Spotify |
...
│
└── /deck
    └── Engaged-but-Empty.pptx         ← Final presentation deck
```
